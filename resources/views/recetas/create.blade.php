    ...
    <div class="content flex flex-col">
        <div class="py-4">
            <span class="text-pretty text-xs font-light">
                Aquí podrás crear una nueva receta. Selecciona el producto principal y los ingredientes requeridos 
        ...
        <form action="{{ route('recetas.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nro" id="nro" required maxlength="20" value="{{ old('nro') }}"
            ...
            <!-- Sección de ingredientes con clases específicas -->
            <div class="mb-6">
...
<script>
    // Script mejorado para habilitar campos de cantidad
