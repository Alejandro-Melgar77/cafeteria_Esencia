        ...
        <div class="content flex flex-col">
            <div class="py-4">
                <span class="text-pretty text-xs font-light">
                    Aqui podras editar un nuevo rol, recuerda que los roles son importantes para la seguridad del sistema,
                    por lo que debes tener cuidado al editar los roles.
                </span>
            </div>
            <form action="{{ route('roles.update', [$rol->id]) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Cargo" id="Cargo" value="{{ old('Cargo', $rol->Cargo) }}" required
