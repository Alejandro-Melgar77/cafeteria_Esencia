    ...
    <div class="flex flex-col dark:text-coffee min-h-screen transition-colors duration-300">
        ...
        <header id="mainHeader"
            ...
            <div class="flex justify-end gap-2 px-6">
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            ...
                            <button
                                ...
                                <x-heroicon-o-arrow-right-on-rectangle
                                    class="h-6 w-6 text-brown-100 group-hover:text-black" />
                                {{-- <span class="hide-menu text-brown-100 group-hover:text-black">Cerrar sesión</span> --}}
                            </button>
                        </form>
                    </div>
                @else
                ...
                <button class="bg-brown-400 p-2 rounded-full hover:bg-brown-200 group cursor-pointer size-10">
                    <x-heroicon-o-user class="h-6 w-6 text-brown-100 group-hover:text-black" />
                </button>
            </div>
        </header>
