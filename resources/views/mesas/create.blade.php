        ...
        <div class="content flex flex-col">
            <div class="py-4">
                <span class="text-pretty text-xs font-light">
                    Aquí podrás registrar una nueva mesa, ingresa la información
                    requerida en el formulario para agregar mesas al sistema.
                </span>
            </div>
            ...
            <form action="{{ route('mesas.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="Nro" id="Nro" value="{{ old('Nro') }}" required min="1"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="Capacidad" id="Capacidad" value="{{ old('Capacidad') }}" required min="1"
                        class="mt-1 w-full px-3 py-2 rounded-lg outline-1 
                            -outline-offset-1 outline-brown-300 focus:outline-2 
