    ...
    <div class="flex flex-col bg-white rounded-xl shadow p-8">
        <div class="flex flex-col">
            <div class="title flex justify-between items-center">
                <h4 class="font-semibold text-xl">Clientes registrados</h4>
            ...
            <div class="py-4">
                <span class="text-pretty text-sm font-light">
                    Aquí podrás ver todos los clientes registrados en el sistema, puedes crear nuevos clientes o
                    editar los existentes, además puedes eliminar los clientes que ya no necesites.
                </span>
            </div>
                                    ...
                                    <div class="flex space-x-2 justify-center">
                                        ...
                                        <form action="{{ route('clientes.destroy', [$cliente->id]) }}" method="POST">
                                            ...
                                            <button
                                                ...
                                                type="submit"
                                                onclick="return confirm('Estas seguro de eliminar el ID: {{ $cliente->id }}?')">
