            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-brown-200">
                    ...
                    <tbody class="bg-white divide-y divide-brown-200">
                        <?php $__currentLoopData = $notasDeVenta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-brown-900">
                                S/ <?php echo e(number_format($nota->importe, 2)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-brown-900">
                                <?php echo e($nota->usuario->Nombre); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-brown-900">
                                <?php echo e($nota->metodoPago->nombre); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="<?php echo e(route('comprobantes.generar', $nota->id)); ?>" 
...
<?php echo $__env->make('layouts.general', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cafeteria_Esencia-master\resources\views/comprobantes/index.blade.php ENDPATH**/ ?>