...
<body>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(Auth::user()->usuario->rol->Cargo == 'administrador'): ?>
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="<?php echo e(url('/')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('roles.index')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('privilegios.index')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('clientes.index')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('personal.index')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('descargarBitacoraPdfall')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('inventarios.index')); ?>" aria-expanded="false">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('usuarios.show', [Auth::user()->id])); ?>" aria-expanded="false">
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->usuario->rol->Cargo == 'personal'): ?>
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('clientes.index')); ?>" aria-expanded="false">
                                        <i class="mdi mdi-border-none"></i>
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->usuario->rol->Cargo == 'cliente'): ?>
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        href="<?php echo e(route('usuarios.show', [Auth::user()->id])); ?>" aria-expanded="false">
                                        <i class="mdi mdi-file"></i>
                        ...
                        <?php else: ?>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('login')); ?>"
                                    aria-expanded="false">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="<?php echo e(route('register')); ?>" aria-expanded="false">
    ...
    <script src="<?php echo e(asset('js/pages/dashboards/dashboard1.js')); ?>"></script>
...
<?php /**PATH C:\Users\aleme\Desktop\cafeteriaEsencia Paypal1\cafeteria_Esencia paypal1\resources\views/layouts/app.blade.php ENDPATH**/ ?>